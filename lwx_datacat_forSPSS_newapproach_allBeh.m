...
for w = 1:length(wm_measure_here)
    ...
    t_out = array2table(cat(2, d.subID, d.gp_age, d.gp_lit, d.gp_vm, ...
        ...
        d.WJIV_LetterWordIdentification, d.WJIV_Spelling, d.WJIV_WordAttack, d.WJIV_SpellingOfSounds, table2array(toi(:, 2:end))), ...
        ...
        'WJIV_LetterWordIdentification', 'WJIV_Spelling', 'WJIV_WordAttack', 'WJIV_SpellingOfSounds', toi.Properties.VariableNames{2:end}});
